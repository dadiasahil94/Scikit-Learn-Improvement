...
def main():
    ...
    if (sys.argv[1] == 'generate'):
        ...
        # Data parameters
        mean_1 = [0, 0]
        cov_1 = np.array([[14, 0], [0, 3.2]])

        mean_2 = [3, 2]
        cov_2 = np.array([[2, 0], [0, 5]])
        ...
        label_1 = np.array(([0] * n_pts), dtype=int)
        label_2 = np.array(([1] * n_pts), dtype=int)
        ...
        # Start training
        lda_first = LinearDiscriminantAnalysis(store_covariance=True)
        ...
        # plt.legend(loc='upper left',  fontsize='x-small').get_frame().set_alpha(0.5)
